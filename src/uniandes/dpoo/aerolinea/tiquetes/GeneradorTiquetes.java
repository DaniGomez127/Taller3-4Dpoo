...
public class GeneradorTiquetes
{
     ...
     * @param nuevoTiquete El código que se quiere consultar
     * @return Retorna true si ya se tenía registrado un tiquete con el código dado
     */
    public static boolean validarTiquete( Tiquete nuevoTiquete )
    {
      
    	return codigos.contains(nuevoTiquete.getCodigo());
